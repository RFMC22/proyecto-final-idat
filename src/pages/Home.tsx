      ...
      <div className="container container-menu-home">
        <div className="top-content">
          ...
          <div className="btn-content">
            ...
            <button className="btn-next none-l-m">
              <svg
                version="1.1"
                id="Capa_1"
                xmlns="http://www.w3.org/2000/svg"
